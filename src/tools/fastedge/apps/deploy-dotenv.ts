...
export function registerDeployDotEnvTool(
  ...
  server.registerTool(
    "update-env-vars-app",
    {
      title: 'Update "Environment Variables", "Secrets", "Stores" and/or "Response Headers" for FastEdge Application',
      description: "Update environment variables for a FastEdge application using the FastEdge API",
      inputSchema: {
        appId: z
          .string()
          .optional()
