...
export function registerMagicCommentsTools(server: McpServer) {
  server.registerTool(
    "deployment-comments",
    {
      title: "Generate Magic Comments for keeping track of deployment info within a code file",
      description: 'Generate deployment comments ( "Magic Comments" ) for a FastEdge application and insert them in the code file.',
      inputSchema: {
        codeFile: z
          .string()
          .optional()
